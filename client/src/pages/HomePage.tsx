    ...
    return (
      <div className={classes.body}>
        ...
        <h4>This site is made with lots of love and aims to popularize movie watching by sharing information about many of them. 
          ...
          I should note that this site is still under development and the collection of movie content is not large 
          and not all the bugs on the site have been fixed. Thanks for understanding!</h4>
      </div>
    );
  }